...
function getRow(state: State, viewportY: number, favorScrollableContent: boolean): [number, GridRow] {
...
function getColumn(state: State, viewportX: number, favorScrollableContent: boolean): [number, GridColumn] {
    const cellMatrix = state.cellMatrix;
