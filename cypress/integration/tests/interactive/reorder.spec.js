...
context('Reorder', () => {
    ...
    it('Should reorder column to right', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 100, 10);
        for (let x = 100; x < 400; x += 10) {
            cy.get('[data-cy=reactgrid]').trigger('pointermove', x, 10);
        }
    ...
    it('Should reorder column to left', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 450, 10);
    ...
    it('Should select more columns and reorder to left', () => {
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 700, 10);
    ...
    it('Should select more columns and reorder to right', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 300, 10);
    ...
    it('Should reorder one row to bottom', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 100, 40);
        for (let y = 100; y < 300; y += 10) {
            cy.get('[data-cy=reactgrid]').trigger('pointermove', 10, y);
        }
        cy.get('[data-cy=reactgrid]').trigger('pointerup', { force: true });
        cy.wait(200);
    });
    ...
    it('Should reorder one row to top', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 100, 300);
    ...
    it('Should select more rows and reorder to top', () => {
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 100, 500);
    ...
    it('Should select more rows and reorder to bottom', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 100, 200);
    ...
    it('Should select more rows and reorder to top', () => {
        ...
        cy.get('[data-cy=reactgrid]').trigger('pointerdown', 100, 340);
