    ...
    function PointerEventsController(updateState) {
        ...
        this.handlePointerUp = function (event) {
            ...
            _this.updateState(function (state) {
                ...
                if (event.pointerType !== 'mouse' &&
                    currentLocation.equals(_this.pointerDownLocation) &&
                    event.pointerType !== undefined &&
                ...
                if (currentTimestamp - secondLastTimestamp < 500 && currentLocation.equals(_this.eventLocations[0]) && currentLocation.equals(_this.eventLocations[1])) {
                    state = state.currentBehavior.handleDoubleClick(event, currentLocation, state);
                }
                if (event.pointerType !== 'mouse' && currentTimestamp - _this.eventTimestamps[_this.currentIndex] >= 500 && currentLocation.equals(_this.eventLocations[0]) && currentLocation.equals(_this.eventLocations[1])) {
