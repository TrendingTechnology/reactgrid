...
var CheckboxCellTemplate = (function () {
    ...
    CheckboxCellTemplate.prototype.validate = function (cell) {
        return __assign(__assign({}, cell), { text: cell.value !== undefined || cell.value !== null ? cell.value.toString() : '' });
    };
    CheckboxCellTemplate.prototype.handleKeyDown = function (cell, keyCode, ctrl, shift, alt) {
        if (keyCode === keyCodes.SPACE || keyCode === keyCodes.ENTER)
            return { cell: __assign(__assign({}, cell), { value: !cell.value }), enableEditMode: false };
    ...
    CheckboxCellTemplate.prototype.update = function (cell, newCell) {
        if (newCell.value !== undefined && newCell.value !== NaN)
            return __assign(__assign({}, cell), { value: newCell.value });
        var text = newCell.text;
        return __assign(__assign({}, cell), { value: text.length > 0 ? true : false });
    };
    CheckboxCellTemplate.prototype.render = function (cell, isInEditMode, onCellChanged) {
        return (React.createElement("label", { className: "rg-checkbox-container" },
            React.createElement("input", { type: "checkbox", className: "rg-checkbox-cell-input", checked: cell.value, onChange: function (e) { return onCellChanged(__assign(__assign({}, cell), { value: !cell.value }), true); } }),
